...
// func resourceLegacyAuthorizationCreate(d *schema.ResourceData, meta interface{}) error {
...
// func resourceLegacyAuthorizationDelete(d *schema.ResourceData, meta interface{}) error {
// 	influx := m.(meta).influxsdk.(influxdb2.Client)
// 	id := d.Id()
...
// func resourceLegacyAuthorizationRead(d *schema.ResourceData, meta interface{}) error {
// 	influx := m.(meta).influxsdk.(influxdb2.Client)
...
// func resourceLegacyAuthorizationUpdate(d *schema.ResourceData, meta interface{}) error {
// 	influx := m.(meta).influxsdk.(influxdb2.Client)
// 	id := d.Id()
// 	authorization := domain.Authorization{
// 		Id: &id,
...
// func getLegacyPermissions(input interface{}) []domain.Permission {
...
func getLegacyAuthorizationsById(input *[]domain.Authorization, id string) domain.Authorization {
